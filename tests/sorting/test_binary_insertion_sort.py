"""
Test de rendimiento y robustez para BinaryInsertionSort
...
from app.algorithms.sorting.binary_insertion_sort import BinaryInsertionSort
...
class TestBinaryInsertionSort:
    ...
    def setup_method(self):
        ...
        self.sorter = BinaryInsertionSort()
    ...
    def test_binary_insertion_sort_full_benchmark(self):
        """
        ...
        try:
            ...
            # Fuerza el fallo del test en Pytest reportando el error.
            pytest.fail(f"El algoritmo falló con {len(data)} datos: {str(e)}")

    def test_binary_insertion_sort_stress_progressive(self):
        """
    ...
    def test_binary_insertion_sort_edge_cases(self):
        """
